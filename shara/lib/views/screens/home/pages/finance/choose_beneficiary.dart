      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20,),
            Text('beneficiaries'.tr,style: TextStyle(
              color: AppColors.mainDarkGreyColor,
              fontSize: 18,
              fontWeight: FontWeight.bold
            ),),
            SizedBox(height: 20,),
            Text('choose_beneficiaries'.tr,style: TextStyle(
                color: AppColors.mainDarkGreyColor,
                fontSize: 17,
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text('transfer_to_new'.tr,style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold
                  ),),
            ...
            SizedBox(height: 20,),
            Text('ex_transfers'.tr,style: TextStyle(
                color: AppColors.mainDarkGreyColor,
                fontSize: 17,
                fontWeight: FontWeight.w500
            ),),
